...
import com.micoredu.readerlib.bean.FindKindGroupBean;
...
class ChapterProvider {
    ...
    TxtChapter dealLoadPageList(BookChapterBean chapter, boolean isPrepare) {
        ...
        if (!isPrepare || pageLoader.noChapterData(chapter)) {
            if (pageLoader instanceof PageLoaderNet && !NetworkUtils.isNetWorkAvailable(BaseApplication.getInstance())) {
