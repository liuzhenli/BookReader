...
import com.liuzhenli.common.utils.AppConst.dateFormat
...
import com.micoredu.reader.help.http.BackstageWebView
import com.micoredu.reader.help.http.CookieStore
import com.micoredu.reader.help.http.SSLHelper
import com.micoredu.reader.help.http.StrResponse
import com.micoredu.reader.help.source.SourceVerificationHelp
import com.micoredu.reader.model.Debug
import com.micoredu.reader.model.analyzeRule.AnalyzeUrl
import com.micoredu.reader.model.analyzeRule.QueryTTF
import com.micoredu.reader.utils.*
import com.micoredu.reader.utils.fromJsonObject
import com.micoredu.reader.utils.readBytes
import com.micoredu.reader.utils.readText
...
//******************文件操作************************//
     ...
     */
    fun toast(msg: Any?) {
        ToastUtil.showToast("${getSource()?.getTag()}: ${msg.toString()}")
    }
