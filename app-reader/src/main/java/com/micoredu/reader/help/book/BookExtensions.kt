...
import com.liuzhenli.common.utils.FileDoc
import com.liuzhenli.common.utils.ToastUtil
import com.liuzhenli.common.utils.exists
import com.liuzhenli.common.utils.find
...
fun Book.getLocalUri(): Uri {
    ...
    if (!defaultBookDir.isNullOrBlank()) {
        ...
        if (!treeFileDoc.exists()) {
            ToastUtil.showToast("书籍保存目录失效，请重新设置！")
        } else {
