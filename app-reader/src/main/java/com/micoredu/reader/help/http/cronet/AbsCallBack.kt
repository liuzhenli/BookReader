...
import com.liuzhenli.common.utils.asIOException
...
abstract class AbsCallBack(
    ...
    override fun onResponseStarted(request: UrlRequest, info: UrlResponseInfo) {
        ...
        //打印协议，用于调试
        LogUtils.e(javaClass.simpleName, "start[${info.negotiatedProtocol}]${info.url}")
    ...
    override fun onReadCompleted(
        ...
        try {
            ...
            LogUtils.e(javaClass.name, "IOException during ByteBuffer read. Details: ${e.message}" )
