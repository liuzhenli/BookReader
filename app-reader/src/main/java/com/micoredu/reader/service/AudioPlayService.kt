...
import com.micoredu.reader.constant.Status
import com.micoredu.reader.dao.appDb
import com.micoredu.reader.help.MediaHelp
import com.micoredu.reader.help.exoplayer.ExoPlayerHelper
...
import com.microedu.lib.reader.Reciever.MediaButtonReceiver
    ...
    private fun play() {
        ...
        if (requestFocus()) {
            execute(context = Main) {
                ...
                ToastUtil.showToast("$url ${it.localizedMessage}")
                stopSelf()
            }
        }
    }
        ...
        durChapter?.let { chapter ->
            if (addLoading(chapter.index)) {
                ...
                if (book != null && bookSource != null) {
                    ...
                    removeLoading(chapter.index)
                    ToastUtil.showToast("book or source is null")
                }
            }
        }
    }
    ...
    private fun upNotification() {
        execute {
            ...
            kotlin.runCatching {
                ...
                BitmapFactory.decodeResource(resources, R.drawable.icon_book)
            }.let {
