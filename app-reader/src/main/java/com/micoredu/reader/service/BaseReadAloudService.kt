...
abstract class BaseReadAloudService : BaseService(),
    ...
    override fun onCreate() {
        ...
        if (AppConfig.ttsTimer > 0) {
            ToastUtil.showToast("朗读定时 ${AppConfig.ttsTimer} 分钟")
        }
    }
    ...
    private fun upNotification() {
        execute {
            ...
            val builder = NotificationCompat
                ...
                .setContentIntent(
                    activityPendingIntent<ReaderActivity>("activity")
                )
            kotlin.runCatching {
                ImageLoader
                ...
                BitmapFactory.decodeResource(resources, R.drawable.book_cover)
            }.let {
