...
import com.micoredu.reader.model.task.DownloadTaskImpl;
...
public class DownloadService extends Service {
    ...
    public void onCreate() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, BaseApplication.channelIdDownload)
        ...
        threadsNum = SharedPreferencesUtil.getInstance().getInt(this.getString(R.string.pk_threads_num), 4);
