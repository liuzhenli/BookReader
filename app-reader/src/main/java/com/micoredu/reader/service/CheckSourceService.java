...
import com.micoredu.reader.utils.CheckSourceTask;
...
import static com.liuzhenli.common.constant.AppConstant.ActionStartService;
...
public class CheckSourceService extends Service {
    ...
    public void onCreate() {
        ...
        threadsNum = SharedPreferencesUtil.getInstance().getInt(this.getString(R.string.pk_threads_num), 6);
