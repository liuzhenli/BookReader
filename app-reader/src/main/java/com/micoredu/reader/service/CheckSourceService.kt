...
import com.micoredu.reader.exception.ContentEmptyException
import com.micoredu.reader.help.source.exploreKinds
import com.micoredu.reader.model.CheckSource
import com.micoredu.reader.model.Debug
import com.micoredu.reader.model.Debug.getRespondTime
import com.micoredu.reader.model.Debug.updateFinalMessage
...
class CheckSourceService : BaseService() {
    ...
    private fun check(ids: List<String>) {
        if (allIds.isNotEmpty()) {
            ToastUtil.showToast("已有书源在校验,等完成后再试")
            return
        }
        allIds.clear()
        checkedIds.clear()
