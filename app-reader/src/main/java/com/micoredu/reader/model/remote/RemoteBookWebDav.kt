...
import com.micoredu.reader.constant.AppPattern.bookFileRegex
...
import com.micoredu.reader.utils.isContentScheme
...
object RemoteBookWebDav : RemoteBookManager() {
    ...
    override suspend fun upload(book: Book) {
        if (!NetworkUtils.isNetWorkAvailable(appCtx)) throw NoStackTraceException("网络不可用")
