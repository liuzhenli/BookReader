...
import static com.micoredu.reader.utils.ReaderConfig.PageMode.SLIDE;
...
public class ReadConfigManager {
    ...
    private void initTextDrawable() {
        if (null == mTextDrawable) {
            ...
            temp1.put("textColor", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_day_reader_scene_text_color));
            temp1.put("bgIsColor", 1);
            temp1.put("textBackground", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_day_reader_scene_bg_color));
            temp1.put("darkStatusIcon", 1);
            mTextDrawable.add(temp1);

            //1 黄
            Map<String, Integer> temp2 = new HashMap<>();
            temp2.put("textColor", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_yellow_reader_scene_text_color));
            temp2.put("bgIsColor", 1);
            temp2.put("textBackground", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_yellow_reader_scene_bg_color));
            temp2.put("darkStatusIcon", 1);
            mTextDrawable.add(temp2);

            //2 绿
            Map<String, Integer> temp3 = new HashMap<>();
            temp3.put("textColor", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_green_reader_scene_text_color));
            temp3.put("bgIsColor", 1);
            temp3.put("textBackground", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_green_reader_scene_bg_color));
            temp3.put("darkStatusIcon", 1);
            mTextDrawable.add(temp3);

            //3 粉
            Map<String, Integer> temp4 = new HashMap<>();
            temp4.put("textColor", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_pink_reader_scene_text_color));
            temp4.put("bgIsColor", 1);
            temp4.put("textBackground", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_pink_reader_scene_bg_color));
            temp4.put("darkStatusIcon", 0);
            mTextDrawable.add(temp4);

            //4 深蓝
            Map<String, Integer> temp5 = new HashMap<>();
            temp5.put("textColor", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_sblue_reader_scene_text_color));
            temp5.put("bgIsColor", 1);
            temp5.put("textBackground", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_sblue_reader_scene_bg_color));
            temp5.put("darkStatusIcon", 0);
            mTextDrawable.add(temp5);

            //5 蓝
            Map<String, Integer> temp6 = new HashMap<>();
            temp6.put("textColor", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_blue_reader_scene_text_color));
            temp6.put("bgIsColor", 1);
            temp6.put("textBackground", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_blue_reader_scene_bg_color));
            temp6.put("darkStatusIcon", 0);
            mTextDrawable.add(temp6);

            //6 夜间
            Map<String, Integer> temp7 = new HashMap<>();
            temp7.put("textColor", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_night_reader_scene_text_color));
            temp7.put("bgIsColor", 1);
            temp7.put("textBackground", BaseApplication.Companion.getInstance().getResources().getColor(R.color.skin_night_reader_scene_bg_color));
    ...
    private int getScreenBrightness() {
        int value = 0;
        ContentResolver cr = BaseApplication.Companion.getInstance().getContentResolver();
        try {
