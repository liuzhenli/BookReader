package com.micoredu.reader.widgets.code
...
import com.micoredu.reader.widgets.text.ScrollMultiAutoCompleteTextView
import java.util.*
...
class CodeView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    private var mAutoCompleteTokenizer: MultiAutoCompleteTextView.Tokenizer? = null
