...
public class ReplaceRuleDialog extends Dialog {
...
/*                        if (s.toString().replaceAll("[\\s,]", "").length() > 0)
            ...
            cbUseRegex.setChecked(SharedPreferencesUtil.getInstance().getBoolean("useRegexInNewRule", false));
    ...
    public void dismiss() {
        ...
        if (view instanceof TextView) {
            SoftInputUtils.hideSoftInput(getContext(), view);
        }
        super.dismiss();
    }
