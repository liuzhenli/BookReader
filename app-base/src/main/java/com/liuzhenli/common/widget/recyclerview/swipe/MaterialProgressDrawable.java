...
package com.liuzhenli.common.widget.recyclerview.swipe;
...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * Update the background color of the circle mBitmap view.
     */
    ...
    /**
     * Set the colors.xml used in the progress animation from color resources.
    ...
    private static class Ring {
        ...
        /**
         * Set the colors.xml the progress spinner alternates between.
         *
         * @param colors Array of integers describing the colors.xml. Must be non-<code>null</code>.
         */
        public void setColors(@NonNull int[] colors) {
            mColors = colors;
            // if colors.xml are reset, make sure to reset the color index as well
            setColorIndex(0);
        }
         ...
         * wrap back to the beginning of colors.xml.
         */
