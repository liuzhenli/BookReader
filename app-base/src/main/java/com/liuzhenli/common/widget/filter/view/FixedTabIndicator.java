package com.liuzhenli.common.widget.filter.view;
...
public class FixedTabIndicator extends LinearLayout {
    ...
    private int mDividerPadding = 12;// 分割线距离上下padding
    ...
    private void init(Context context) {
        ...
        mDividerPadding = DensityUtil.dip2px(context, mDividerPadding);
        drawableRight = DensityUtil.dip2px(context, drawableRight);
    }
