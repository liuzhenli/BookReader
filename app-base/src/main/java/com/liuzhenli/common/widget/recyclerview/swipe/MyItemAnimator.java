 ...
 * a RecyclerView. RecyclerView uses a MyItemAnimator by default.
 *
...
public class MyItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration())
                .scaleY(0).alpha(0).setListener(new VpaListenerAdapter() {
            @Override
            ...
            public void onAnimationEnd(View view) {
                ...
                View front = view.findViewWithTag("front");
                View left = view.findViewWithTag("reveal-left");
                left.setVisibility(View.INVISIBLE);
                view.setBackground(null);
                if (front!=null){
                    ViewCompat.setTranslationX(front,0);
                }
