package com.liuzhenli.common.widget.recyclerview.adapter;
...
import com.liuzhenli.common.utils.image.GlideCircleTransform;
import com.liuzhenli.common.utils.image.GlideRoundTransform;
import com.liuzhenli.common.widget.BookContentTextView;
...
abstract public class BaseViewHolder<M> extends RecyclerView.ViewHolder {
    ...
    public void someRefresh(int position){
    ...
    public BaseViewHolder setBookContentText(int viewId, String value) {
        BookContentTextView view = getView(viewId);
        view.setText(value);
        return this;
    }

    public BaseViewHolder setMovementMethod(int viewId) {
        TextView view = getView(viewId);
    ...
    public BaseViewHolder setStar(int viewId, float value) {
