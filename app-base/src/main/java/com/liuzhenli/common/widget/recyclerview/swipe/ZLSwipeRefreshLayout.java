...
public class ZLSwipeRefreshLayout extends FrameLayout {
    ...
    private static final String LOG_TAG = ZLSwipeRefreshLayout.class.getSimpleName();
    ...
    private AnimationListener mRefreshListener = new AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            if (mRefreshing) {
                ...
                if (mNotify) {
                    if (mListener != null) {
//                        SharedPreferencesUtil.getInstance().putString(Constant.ONREFRESH_IN_SOME_PAGE,);
//                        ReaderApplication.randParamsInPage = mContext.getClass().getSimpleName();
                        mListener.onRefresh();
                    }
                }
            } else {
     ...
     * @param attrs
     */
    public ZLSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * Set the colors.xml used in the progress animation. The first
