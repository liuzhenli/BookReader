...
//                appCtx.getPrefBoolean(PreferKey.useZhLayout)
    ...
    private fun getPrefUserAgent(): String {
        ...
        if (ua.isNullOrBlank()) {
            return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/" + Cronet_Version + " Safari/537.36"
        }
        return ua
    }
    ...
    fun detectClickArea() {
        if (clickActionTL * clickActionTC * clickActionTR
            ...
            * clickActionBL * clickActionBC * clickActionBR != 0
            ...
            ToastUtil.showToast("当前没有配置菜单区域,自动恢复中间区域为菜单.")
        }
    }
}
