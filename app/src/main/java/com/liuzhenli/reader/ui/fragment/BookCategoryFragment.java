...
// */
//public class BookCategoryFragment extends BaseRVFragment<BookListPresenter, SearchBook> implements BookListContract.View {
//
...
//
//    @Override
//    public void showBookList(List<SearchBook> data) {
//        hideDialog();
//        mRecyclerView.setRefreshing(false);
//        if (mAdapter.getCount() != 0 && mPage == 1) {
//            DataDiffUtil.diffResult(mAdapter, data, new DataDiffUtil.ItemSameCallBack<SearchBook>() {
//                @Override
